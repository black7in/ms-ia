...
SQL_SYSTEM_PROMPT = (
    ...
    "5. Para fechas relativas como 'esta semana', 'mes anterior', 'mayo', "
    "usa SIEMPRE CURRENT_DATE y funciones de fecha.\n"
    "6. NUNCA pongas un año manual (2023, 2024, etc). "
    "Siempre usa CURRENT_DATE o EXTRACT.\n"
    "7. Para agregaciones usa alias descriptivos con AS.\n"
    "8. Usa los JOIN correctos segun las foreign keys del esquema.\n"
    "9. Si la pregunta no es sobre datos del negocio (ventas, viajes, "
